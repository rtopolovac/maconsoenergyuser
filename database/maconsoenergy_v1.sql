...
CREATE TABLE IF NOT EXISTS `consommation` (
  ...
  KEY `Id_Type_Conso` (`Id_Type_Conso`),
  KEY `Id_Foyer` (`Id_Foyer`),
  CONSTRAINT `consommation_ibfk_1` FOREIGN KEY (`Id_Type_Conso`) REFERENCES `type_conso` (`Id_Type_Conso`),
  CONSTRAINT `consommation_ibfk_2` FOREIGN KEY (`Id_Foyer`) REFERENCES `foyer` (`Id_Foyer`)
